...
test = pd.read_csv(base_path + 'invite_info_evaluate_1_0926.txt', sep='\t', header=None)
...
#model_lgb = LGBMClassifier(n_estimators=4000,max_bin=100,num_leaves=20, objective='binary', seed=500, silent=True,learning_rate =0.01,n_jobs=-1)
...
print('result===============')
sub.to_csv('result_base2_v2.3.2.txt', index=None, header=None, sep='\t') #2.3 调整时间窗口  .2 删去下采样
...
df.to_csv("feature_score_2.3.2.csv",index=None,encoding='gbk')
